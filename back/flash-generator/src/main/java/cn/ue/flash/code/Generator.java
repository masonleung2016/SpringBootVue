...
public class Generator {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String module = "test";
    String basePackageName = "cn.ue.flash";
    ...
    options.addOption("p", "package", true, "base package name,default:cn.ue.flash");
  ...
  public static Pattern getIncludePattern() {
    return includePattern;
  }

  public static void setIncludePattern(Pattern includePattern) {
    Generator.includePattern = includePattern;
  }
