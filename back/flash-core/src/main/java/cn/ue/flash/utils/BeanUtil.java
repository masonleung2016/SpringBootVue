...
public class BeanUtil {
   ...
   * 缓存字段名和中文注释对应关系的map
   */
  private static Map<String, String> fieldMap = cn.ue.flash.utils.Maps.newHashMap();
  ...
  public static Pattern getColumnDefinitionPattern() {
    return COLUMN_DEFINITION_PATTERN;
  }
