...
import cn.ue.flash.bean.constant.cache.Cache;
import cn.ue.flash.bean.vo.query.DynamicSpecifications;
...
/**
 * @Description: 基础服务类
 *               本服务类使用了@Cache相关注解做缓存管理，如果子类要实现缓存管理的方法，务必保证参数名和父类一致，
 *               否则缓存管理将失败；如果必须更改参数名，请在子类中覆写缓存配置
 * @Author: LCF
