package cn.ue.flash.utils.cache;
...
//                        Time.sleep(sleepTime);
  ...
  public static int getDefaultNumBuckets() {
  ...
  public LinkedList<HashMap<K, V>> getBuckets() {
    return buckets;
  }

  public void setBuckets(LinkedList<HashMap<K, V>> buckets) {
  ...
  public ExpiredCallback getCallback() {
    return callback;
  }
